...
## Fork Changes (Trans-ltd/claude-code-action@beta)
...
- **Updated Base Action**: Uses `Trans-ltd/claude-code-base-action@beta` which includes OAuth credential handling
